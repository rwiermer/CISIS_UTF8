...
char *CIB7::b7_run(RECSTRU *irecp, char *dbnamp,
                ...
                unsigned char uctab[], 
#endif /*        UTF8 */        
				char *btch0p, RECSTRU *tlirecp,
		RECSTRU *crecp, int *errnop)
#else /* CICPP */
char *b7_run(cib7p,irec,dbnamp,buffup,buffuplen,tell,
#if UTF8
				uctab_utf8,
#else
                uctab,
   ...
   while (*b7p != OPRXEND) {
      ...
      *q='\0';
      ...
      if (b7opxlen) {
         ...
         if (b7_xlkey(B7_THISP (char *)b7opx,buffup,
#if UTF8
			uctab_utf8,
#else
		 	uctab,
...
#if CICPP
char * CIB7 :: b7_xlkey(char *opx,char *bufp,
#if UTF8
STRUCT_ISISUCTAB_UTF8 uctab_utf8[],
#else
unsigned char uctab[],
#endif // UTF8
char *xlfilp,int *opxlp)
#else
char *b7_xlkey(cib7p,opx,bufp,
#if UTF8
uctab_utf8,
#else
uctab,
...
#if UTF8
	uppercase_utf8_length(uctab_utf8,bufp,*opxlp);
#else
